              ...
              <div className="space-y-2">
                ...
                {!previewMode && (
                  <div className="flex flex-wrap items-center gap-1.5 p-2 bg-slate-950 border border-slate-800 rounded-xl">
                    ...
                    <button
                      type="button"
                      onClick={() => insertFormatting('### Bismillah-ir-Rahman-ir-Rahim\n\n')}
                      className="px-2 py-1 bg-emerald-950/80 text-emerald-300 hover:bg-emerald-900 border border-emerald-700/60 text-xs font-bold rounded-md"
                      title="Insert Basmala"
                    >
                      + Bismillah
                    </button>
                  </div>
