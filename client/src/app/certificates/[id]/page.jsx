        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-10 items-end">
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-amber-600 via-amber-400 to-amber-200 p-1 shadow-lg ring-4 ring-amber-100 flex items-center justify-center">
