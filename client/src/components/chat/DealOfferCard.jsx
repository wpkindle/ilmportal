...
import { Sparkles, CheckCircle2, XCircle, Clock, Video, Home, MapPin, CreditCard, ShieldCheck, Award, AlertTriangle, X, Star, Upload } from 'lucide-react';
              ...
              {dealState.paymentStatus === 'submitted_proof' && !isFeeCleared && (
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-[#0c2217] hover:bg-[#143d2b] text-white text-[11px] font-bold rounded-xl shadow-xs transition-all cursor-pointer flex items-center gap-1 border border-[#d4a359]/30"
                    title="Click to view or submit new screenshot"
                  >
                    <Upload className="w-3 h-3 text-[#d4a359]" />
