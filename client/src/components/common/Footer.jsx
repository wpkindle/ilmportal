        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 pb-12 border-b border-[#1b3d2c]">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-2 pt-0.5">
              <a
                href="https://whatsapp.com/channel/0029VbDT9HCI7Be90yESwo3y"
                target="_blank"
                rel="noopener noreferrer"
                title="Follow IlmiDunya on WhatsApp Channel"
                className="w-8 h-8 rounded-xl bg-[#0e271c] hover:bg-[#25D366]/20 border border-[#1d4532] hover:border-[#25D366]/60 flex items-center justify-center transition-all group"
              >
                <svg className="w-3.5 h-3.5 text-[#a3bcaf] group-hover:text-[#25D366] transition-colors" fill="currentColor" viewBox="0 0 24 24">
