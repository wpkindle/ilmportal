    ...
    <>
      ...
      <div className={`fixed z-40 transition-all ${
        ...
        >
          ...
          <span className="hidden sm:inline text-[10px] font-mono text-[#d4a359] bg-[#143d2b] px-2 py-0.5 rounded-full border border-[#2b6e51]/60">
            Sadaqah Jariyah
          </span>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2.5 sm:p-4 bg-[#07150e]/85 backdrop-blur-md animate-in fade-in duration-200">
          ...
          <div
            className="w-full max-w-lg max-h-[90dvh] flex flex-col rounded-3xl bg-[#0c2217] border-2 border-[#2b6e51]/60 shadow-2xl shadow-[#040e09] text-[#f5f0e6] relative animate-in zoom-in-95 duration-200 overflow-hidden"
            role="dialog"
            aria-modal="true"
          >
            {/* Top Warm Gold Accent Line */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#d4a359] via-[#388e6a] to-[#d4a359] z-20" />

            {/* Modal Header */}
            <div className="p-4 sm:p-5 border-b border-[#143d2b] flex items-center justify-between shrink-0 bg-[#0c2217]/95 z-10">
              <div className="flex items-center gap-3">
                <div className="p-2 sm:p-2.5 rounded-2xl bg-[#143d2b] text-[#d4a359] border border-[#2b6e51]/60">
            ...
            <div className="p-3.5 sm:p-5 space-y-4 overflow-y-auto flex-1 overscroll-contain">
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 rounded-2xl border text-center transition-all cursor-pointer flex flex-col items-center justify-center gap-0.5 ${
                          isSelected
                            ? 'bg-[#1e543c] border-[#d4a359] text-white shadow-lg shadow-black/40 ring-1 ring-[#d4a359]'
                            : 'bg-[#143d2b]/60 border-[#2b6e51]/40 text-[#a3b8b0] hover:bg-[#143d2b] hover:text-white'
                        }`}
                      >
              ...
              <div className="rounded-2xl bg-[#07150e] border border-[#2b6e51]/60 p-3.5 sm:p-4 flex flex-col sm:flex-row items-center gap-4 shadow-inner">
                
                {/* QR Code Frame */}
                <div className="p-2.5 bg-white rounded-2xl shadow-xl border-2 border-[#2b6e51] shrink-0 relative group">
                  <img
                  ...
                  <div className="absolute top-1 left-1 w-2.5 h-2.5 border-t-2 border-l-2 border-[#1e543c] pointer-events-none" />
                  <div className="absolute top-1 right-1 w-2.5 h-2.5 border-t-2 border-r-2 border-[#1e543c] pointer-events-none" />
                  <div className="absolute bottom-1 left-1 w-2.5 h-2.5 border-b-2 border-l-2 border-[#1e543c] pointer-events-none" />
                  <div className="absolute bottom-1 right-1 w-2.5 h-2.5 border-b-2 border-r-2 border-[#1e543c] pointer-events-none" />
                </div>
                ...
                <div className="flex-1 text-center sm:text-left space-y-2.5 w-full">
                  ...
                  {/* Method Header Badge */}
                  <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold bg-[#143d2b] border border-[#2b6e51]/60 text-[#d4a359]">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                    <span>{selectedMethod.name}</span>
                  </div>

                  {/* Account Title */}
                  <div className="p-2.5 rounded-xl bg-[#143d2b]/80 border border-[#2b6e51]/60 text-left">
                  ...
                  <div className="p-2.5 rounded-xl bg-[#0c2217] border border-[#2b6e51]/80 text-left flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-[#1e543c] hover:bg-[#286e4e] active:scale-95 text-white text-[11px] font-bold transition-all flex items-center gap-1 shrink-0 cursor-pointer border border-[#2b6e51]"
              ...
              <div className="p-3 sm:p-3.5 rounded-2xl bg-[#143d2b]/50 border border-[#2b6e51]/50 space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  {/* Meezan Bank */}
                  <div className="p-2.5 rounded-xl bg-[#0c2217] border border-[#2b6e51]/40 flex items-center justify-between gap-2">
                    <div>
              ...
              <div className="p-3 rounded-2xl bg-[#143d2b]/40 border border-[#2b6e51]/40 text-[11px] text-[#d1dbd6] flex items-start gap-2.5 leading-relaxed">
            ...
            <div className="p-3.5 sm:p-4 border-t border-[#143d2b] flex items-center justify-between shrink-0 bg-[#0c2217]/95 z-10">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="w-full sm:w-auto px-6 py-2 rounded-xl bg-[#1e543c] hover:bg-[#286e4e] border border-[#2b6e51] text-xs font-bold text-white transition-all cursor-pointer text-center"
              >
                Close Dialog
              </button>
            </div>
