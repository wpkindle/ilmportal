...
import { Clock, CreditCard, AlertCircle, CheckCircle2, ShieldCheck, Sparkles, Upload } from 'lucide-react';
        ...
        {isTutor && onPayClick && (
          deal.paymentStatus === 'submitted_proof' ? (
            <div className="flex items-center gap-1.5 shrink-0">
              <span className="px-2.5 py-1.5 bg-amber-100 text-amber-950 border border-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-2xs">
              ...
              <button
                type="button"
                onClick={onPayClick}
                className="px-3 py-1.5 bg-[#0c2217] hover:bg-[#143d2b] text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer flex items-center gap-1.5 border border-[#d4a359]/30"
                title="Submit payment screenshot again"
              >
