...
const CityGrid = () => {
  ...
  return (
    <section className="py-16 sm:py-24 relative overflow-hidden bg-section-cities border-b border-[#ebe3d3]">
      ...
      <div className="absolute top-1/2 left-10 w-96 h-96 bg-[#059669]/4 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute top-10 right-10 w-80 h-80 bg-[#d4a359]/6 rounded-full blur-[120px] pointer-events-none" />
