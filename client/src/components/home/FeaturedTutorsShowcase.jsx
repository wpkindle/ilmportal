...
export default function FeaturedTutorsShowcase({ initialTutors = [] }) {
  ...
  return (
    <section className="py-16 sm:py-24 relative overflow-hidden bg-section-tutors border-b border-[#ebe3d3]">
      ...
      <div className="absolute top-1/3 inset-x-12 h-px bg-gradient-to-r from-transparent via-[#d4a359]/30 via-[#10b981]/20 to-transparent pointer-events-none animate-light-sweep" />
