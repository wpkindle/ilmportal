...
export default function HowItWorks() {
  ...
  return (
    <section className="py-16 sm:py-24 relative overflow-hidden bg-section-howitworks border-b border-[#ebe3d3]">
      ...
      <div className="absolute top-1/4 left-1/4 w-[520px] h-[340px] bg-[#d4a359]/8 rounded-full blur-[140px] pointer-events-none animate-float-slow" />
      <div className="absolute bottom-0 right-10 w-[450px] h-[450px] bg-[#10b981]/6 rounded-full blur-[140px] pointer-events-none animate-float-reverse" />

      {/* Drifting horizontal light sweep */}
      <div className="absolute top-1/2 inset-x-12 h-px bg-gradient-to-r from-transparent via-[#d4a359]/25 via-[#10b981]/25 to-transparent pointer-events-none animate-light-sweep" />
