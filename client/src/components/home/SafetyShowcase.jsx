...
export default function SafetyShowcase() {
  return (
    <section className="py-20 relative overflow-hidden bg-slate-950 text-white border-b border-slate-900">
      {/* Background Soft Glows */}
      <div className="absolute top-1/2 -left-36 w-96 h-96 bg-emerald-500/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 text-xs font-bold shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {safetyHighlights.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-xl flex flex-col justify-between space-y-4 hover:border-emerald-500/40 hover:scale-[1.02] transition-all duration-300 group"
              >
