        ...
        <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
          ...
          <div className="space-y-1.5 text-xs">
            ...
            {proof.senderAccountTitle && (
              <div className="flex items-center justify-between">
                <span className="text-slate-500 text-[11px]">Sender Account Title:</span>
                <span className="font-bold text-slate-900 bg-white px-2 py-0.5 border border-slate-200 rounded">{proof.senderAccountTitle}</span>
              </div>
            )}
            ...
            {proof.proofImageUrl && (
              <div className="pt-2 border-t border-slate-200/70">
                <span className="text-slate-500 text-[11px] block mb-1 font-semibold">Payment Receipt Screenshot:</span>
                <div className="p-2 bg-white border border-slate-200 rounded-xl flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-xs font-bold text-slate-900 truncate">Student Receipt Attached</p>
                      <p className="text-[10px] text-slate-500">Verified Image Upload</p>
                    </div>
                  </div>
                  <a
                    ...
                    className="px-2.5 py-1.5 bg-[#0c2217] hover:bg-[#143d2b] text-white text-[11px] font-bold rounded-lg transition-colors inline-flex items-center gap-1 shrink-0"
                  >
